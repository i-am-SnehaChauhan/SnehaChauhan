        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#volunteer" className={activeLink === 'volunteer' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('volunteer')}>Volunteer Experiences</Nav.Link>
            </Nav>
            <span className="navbar-text">
              ...
              <HashLink to='https://linktr.ee/SnehaChauhan'>
